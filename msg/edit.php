...
if(file_exists($filename)){
 ...
 if(isset($_POST['editMsg'])){
   ...
   $msgs[$editKey]['username']=$data['username'];
   $msgs[$editKey]['title']=$data['title'];
   $msgs[$editKey]['content']=$data['content'];
 	...
 	<div class="row-fluid">
      ...
      <form action="#" method="post">
        <fieldset>
           ...
           <label>标题</label><input type="text" name="title" value="<?php echo $msgs[$editKey]['title']  ?>" required />
