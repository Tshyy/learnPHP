...
function imgUpload($file)
{
    ...
    {
        $error = isset($file['error'])?isset($file['error']):'';
        msg(2, '服务器繁忙,请稍后再试。错误码：'.$error);
 ...
 * @return string
 */
function GoodsPages($total, $currentPage, $pageSize, $show = 6)
{
    $pageStr = '';
 ...
 */
function UsersPages($total, $currentPage, $pageSize, $show = 6)
{
    $pageStr = '';
